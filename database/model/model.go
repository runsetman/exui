...
type Inbound struct {
	...
	ReverseHttps   bool   `json:"reverseHttps,omitempty" form:"reverseHttps"`
	...
	Relay        bool   `json:"relay,omitempty" form:"relay"`
	RelayAddress string `json:"relayAddress,omitempty" form:"relayAddress"`
}
